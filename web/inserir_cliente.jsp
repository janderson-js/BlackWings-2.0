...
<html>
    ...
    <body>
        ...
        <form name="inserirCliente" method="post" action="inserir_cliente.do">
            <table>
                <tr>
                    <td>Nome</td>
                ...
                <tr>
                    <td></td>
                    <td><input type="checkbox" id="termos" name="termos" value="Aceito" required> <label for="termos"> Aceite os termos para continuar</label></td>
                </tr>
                <tr>
